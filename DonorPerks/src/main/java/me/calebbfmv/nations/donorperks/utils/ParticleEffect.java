...
import me.calebbfmv.nations.donorperks.utils.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
     ...
     * @throws com.tadahtech.pub.utils.ParticleEffect.ParticleVersionException If the particle effect is not supported by the server version
     * @throws com.tadahtech.pub.utils.ParticleEffect.ParticleDataException    If the particle effect requires additional data
     * @throws IllegalArgumentException If the particle effect requires water and none is at the center location
     * @see com.tadahtech.pub.utils.ParticleEffect.ParticlePacket
     */
     ...
     * @param range   Range of the visibility
     * @throws com.tadahtech.pub.utils.ParticleEffect.ParticleVersionException If the particle effect is not supported by the server version
     * @throws com.tadahtech.pub.utils.ParticleEffect.ParticleDataException    If the particle effect does not require additional data or if the data type is incorrect
     * @see com.tadahtech.pub.utils.ParticleEffect.ParticlePacket
     */
    ...
    /**
     * Represents the particle data for effects like ,  and
     * <p>
    ...
    /**
     * Represents the item data for the  effect
     * <p>
     * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    /**
     * Represents the block data for the  and  effects
     * <p>
     * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    public static final class ParticlePacket {
         ...
         *
         * @throws com.tadahtech.pub.utils.ParticleEffect.ParticlePacket.VersionIncompatibleException if your bukkit version is not supported by this library
         */
         ...
         * @throws com.tadahtech.pub.utils.ParticleEffect.ParticlePacket.PacketInstantiationException if instantion fails due to an unknown error
         * @throws com.tadahtech.pub.utils.ParticleEffect.ParticlePacket.PacketSendingException       if sending fails due to an unknown error
         */
